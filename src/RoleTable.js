  ...
  return (
    <div className="App">
      <div className="role-table-container">
        <h1>Roles</h1>
        <button className="create-role-button" onClick={() => setShowCreateRoleModal(true)}>New Role</button>
              ...
              <tr key={role.roleId}>
                ...
                <td>
                  {role.roleId !== 1 && role.roleId !== 2 && (
                    <button className="delete-button" onClick={() => handleDeleteRole(role.roleId)}>Delete</button>
                  )}
                </td>
              </tr>
            ))}
              ...
              <div>
                <label>
                  <input
                    ...
                    onChange={(e) => setNewRole({ ...newRole, read_distribs: e.target.checked })}
                  />
                  Read Distribs
                </label>
              </div>
              <div>
                <label>
                  <input
                    ...
                    onChange={(e) => setNewRole({ ...newRole, read_softs: e.target.checked })}
                  />
                  Read Softs
                </label>
              </div>
              <div>
                <label>
                  <input
                    ...
                    onChange={(e) => setNewRole({ ...newRole, read_errors: e.target.checked })}
                  />
                  Read Errors
                </label>
              </div>
              <div>
                <label>
                  <input
                    ...
                    onChange={(e) => setNewRole({ ...newRole, create_roles: e.target.checked })}
                  />
                  Create Roles
                </label>
              </div>
              <div>
                <label>
                  <input
                    ...
                    onChange={(e) => setNewRole({ ...newRole, delete_roles: e.target.checked })}
                  />
                  Delete Roles
                </label>
              </div>
              <div>
                <label>
                  <input
                    ...
                    onChange={(e) => setNewRole({ ...newRole, edit_roles: e.target.checked })}
                  />
                  Edit Roles
                </label>
              </div>
              <button className="create-button" onClick={handleCreateRole}>Create</button>
              <button className="cancel-button" onClick={() => setShowCreateRoleModal(false)}>Cancel</button>
            </div>
          </div>
        )}
        ...
        {showDeleteModal && (
          <div className="modal">
            <div className="modal-content">
              ...
              <button className="confirm-button" onClick={confirmDeleteRole}>Confirm Delete</button>
